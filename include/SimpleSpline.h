#ifndef _SIMPLE_SPLINE_H
#define _SIMPLE_SPLINE_H
#include <Export.h>
#include <math_3d.h>
#include <vector>
...
@par
	...
	created for you. 
*/
class ENGINE_EXPORT SimpleSpline
{
public:
	SimpleSpline();
	~SimpleSpline();
	...
	const Vector3f& getPoint(unsigned short index) const;
	...
	*/
	void updatePoint(unsigned short index, const Vector3f& value);
	...
	*/
	...
	@param t Parametric value
	*/
	Vector3f interpolate(unsigned int fromIndex, float t) const;
