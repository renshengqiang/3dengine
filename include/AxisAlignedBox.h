...
*/
class ENGINE_EXPORT AxisAlignedBox
{
public:
	enum Extent
	{
...
public:
	...
	*/
	...
	inline AxisAlignedBox() : mMinimum(Vector3f::ZERO), mMaximum(Vector3f::UNIT_SCALE), mCorners(0)
	{
	...
	inline AxisAlignedBox(Extent e) : mMinimum(Vector3f::ZERO), mMaximum(Vector3f::UNIT_SCALE), mCorners(0)
	{
		setMinimum( -0.5, -0.5, -0.5 );
		setMaximum( 0.5, 0.5, 0.5 );
		mExtent = e;
	...
	inline AxisAlignedBox(const AxisAlignedBox & rkBox) : mMinimum(Vector3f::ZERO), mMaximum(Vector3f::UNIT_SCALE), mCorners(0)
	...
	inline AxisAlignedBox( const Vector3f& min, const Vector3f& max ) : mMinimum(Vector3f::ZERO), mMaximum(Vector3f::UNIT_SCALE), mCorners(0)
	{
		setExtents( min, max );
	}
	...
	inline AxisAlignedBox(
		...
		float Mx, float My, float Mz ) : mMinimum(Vector3f::ZERO), mMaximum(Vector3f::UNIT_SCALE), mCorners(0)
	{
...
/*
	ENGINE_EXPORT friend std::ostream& operator<<( std::ostream& o, const AxisAlignedBox aab )
	{
		switch (aab.mExtent)
		{
		case EXTENT_NULL:
